...
export default function HealthPage() {
  ...
  const fetchHealthData = async () => {
    setLoading(true)
    try {
      // This would call your Go API: GET /health
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">API Health Status</h1>
        <p className="text-muted-foreground">Status kesehatan API</p>
      </div>
