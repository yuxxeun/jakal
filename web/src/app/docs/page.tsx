    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex gap-4">
          <Button asChild>
            <Link href="/api/v1/today">Try API</Link>
          </Button>
        ...
        <Card>
          ...
          <CardContent>
            <div className="bg-muted p-3 rounded-lg">
              <code className="text-sm">https://your-api-domain.com</code>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-muted p-4 rounded-lg">
                <code className="text-sm">curl -X GET "https://your-api-domain.com/api/v1/today"</code>
              </div>
            </div>
            <div>
              <h4 className="font-medium mb-2">Convert Specific Date</h4>
              <div className="bg-muted p-4 rounded-lg">
                <code className="text-sm">curl -X GET "https://your-api-domain.com/api/v1/date/2025-01-15"</code>
              </div>
            </div>
            <div>
